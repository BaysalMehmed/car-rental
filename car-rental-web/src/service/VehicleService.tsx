...
export async function addVehicle(vehicle: iVehicle, images: FileList | null): Promise<iVehicle> {
    ...
    images !== null && addImages(formData, images)
...
export async function updateVehicle(vehicle: iVehicle, images: FileList | null): Promise<iVehicle> {
...
function addImages(formData: FormData, images: FileList){
